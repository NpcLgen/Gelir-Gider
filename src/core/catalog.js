...
/** Gider kategorileri; `defaults` yeni gider formunu ön-doldurur. */
export const EXPENSE_CATEGORIES = [
  { key: 'utility_electricity', label: 'Elektrik Faturası', defaults: { allocation: 'weighted', weightKind: 'electricity' } },
  { key: 'utility_water', label: 'Su Faturası', defaults: { allocation: 'weighted', weightKind: 'water' } },
  { key: 'utility_gas', label: 'Doğalgaz / Yakıt', defaults: { allocation: 'weighted', weightKind: 'heating' } },
  { key: 'maintenance', label: 'Bakım / Onarım (Demirbaş)', defaults: { allocation: 'direct' } },
  { key: 'housekeeping', label: 'Temizlik & Sarf Malzeme', defaults: { allocation: 'perGuest' } },
  { key: 'food', label: 'Gıda / Kahvaltı Alımı', defaults: { allocation: 'perGuest' } },
  { key: 'amenityKit', label: 'Buklet / Misafir Seti', defaults: { allocation: 'perGuest' } },
  { key: 'laundry', label: 'Çamaşırhane', defaults: { allocation: 'perGuest' } },
  { key: 'furnishing', label: 'Demirbaş Alımı', defaults: { allocation: 'direct' } },
  { key: 'staff', label: 'Personel', defaults: { allocation: 'equal' } },
  { key: 'rent', label: 'Kira', defaults: { allocation: 'equal' } },
  { key: 'marketing', label: 'Pazarlama / Komisyon', defaults: { allocation: 'general' } },
  { key: 'tax', label: 'Vergi / Resmi Ödemeler', defaults: { allocation: 'general' } },
  { key: 'other', label: 'Diğer', defaults: { allocation: 'general' } },
];
